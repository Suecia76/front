...
const NotificationPrompt = ({ userId }) => {
      ...
      if (result === "granted") {
        if (isOpera() || isSafari()) {
          try {
            ...
            if (token) {
              await axios.post(
                "https://back-1-1j7o.onrender.com/usuarios/suscripcion-fcm",
                {
                  userId,
                  fcmToken: token,
                }
          ...
          await axios.post(
            "https://back-1-1j7o.onrender.com/usuarios/suscripcion-push",
            {
              subscription,
              userId,
            }
  ...
  return (
    <div>
      ...
      {permission === "granted" && <p>Notificaciones activadas</p>}
    </div>
  );
};
