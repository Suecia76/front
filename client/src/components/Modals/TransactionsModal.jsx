    ...
    <ModalWrapper centered={true} onClose={onClose}>
      <div className="modal__content" onClick={(e) => e.stopPropagation()}>
        ...
        <h2>Movimientos del {selectedDate}</h2>
            ...
            <div className="tabs">
              {tabs.map(tab => (<Tab label={tab.label} key={tab.label} isSelected={selectedTab === tab.value} onSelect={()=> setSelectedTab(tab.value)}/>))}
            </div>
        ...
        <section className="movements">
          {
            selectedTab === "ingresos" && (
              ...
              <>
                ...
                <a href="/incomes/add" className="btn btn--filled-blue">Agregar ingreso</a>
              </>
