...
const OutcomeDetail = () => {
    ...
    const fetchOutcome = async (id) => {
      ...
      try {
        ...
        const res = await axios.get(
          `https://app-nttd.onrender.com/gastos/${id}`,
          {
            headers: {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await axios.put(`https://app-nttd.onrender.com/gastos/${id}`, data, {
        headers: {
          Authorization: token ? `Bearer ${token}` : "",
        },
      });
  ...
  async function handleDeleteOutcome(id) {
    ...
    try {
      ...
      await axios.delete(`https://app-nttd.onrender.com/gastos/${id}`, {
        headers: {
          Authorization: token ? `Bearer ${token}` : "",
        },
      });
